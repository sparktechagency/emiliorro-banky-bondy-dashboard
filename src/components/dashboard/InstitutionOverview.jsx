...
const InstitutionOverview = ({ institutionOverviewData, onYearChange }) => {
        ...
        <div className="bg-card p-6 rounded-lg shadow-lg">
            ...
            <ResponsiveContainer width="100%" height={300}>
                <LineChart data={chartData}>
                    ...
                    <Tooltip />
                    <Legend />
                    <Line type="monotone" dataKey="totalInstitutions" name="Total Institutions" stroke="#8884d8" />
                    <Line type="monotone" dataKey="avgMembersPerInstitution" name="Avg Members/Institution" stroke="#82ca9d" />
                </LineChart>
            </ResponsiveContainer>
        </div>
    );
