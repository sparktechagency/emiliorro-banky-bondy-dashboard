    ...
    return (
        <div className="flex h-screen bg-sidebar">
            ...
            <div className="flex-1 flex flex-col">
                ...
                <main className="flex-1 p-4 overflow-y-auto mt-20 min-h-[calc(100vh-80px)] lg:rounded-tl-lg overflow-hidden lg:ml-64 bg-accent dark:bg-accent" onClick={() => isSidebarOpen && setIsSidebarOpen(false)}>
                    <Outlet />
                </main>
            </div>
